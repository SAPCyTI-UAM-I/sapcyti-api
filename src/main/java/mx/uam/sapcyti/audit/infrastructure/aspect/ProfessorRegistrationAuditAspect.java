...
@Slf4j
public class ProfessorRegistrationAuditAspect {
    ...
    @AfterReturning(pointcut = "registerProfessorPointcut()", returning = "result")
    public void auditProfessorRegistered(Object result) {
        if (!(result instanceof RegisterProfessorUseCase.RegisterProfessorResult registered)) {
            return;
        }
    ...
    public void auditProfessorAccessDenied(AccessDeniedException ex) {
        recordEvent(
